...
checkpoint_every=-1, checkpoint_prefix=expanduser("~/scratch/tiger/tiger7k"),
pretty_progress=true)

burn!(chain, 2000)

advance_chain!(chain, nb_steps=30000,
nb_splitmerge=300, nb_gibbs=1, fullseq_prob=0.0,
checkpoint_every=5000, checkpoint_prefix=expanduser("~/scratch/tiger/tiger7k"),
pretty_progress=true)
