module FlowingClusters
    ...
    # function append_tail_probabilities!(clusters::Vector{Cluster}, hyperparams::MNCRPHyperparams; nb_rejection_samples=10000, optimize=true)
    ...
    #     tail_prob = tail_probability(clusters, hyperparams, nb_rejection_samples=nb_rejection_samples)
    ...
    #             tp = tp > 0.0 ? tp : 0.65 * rand() / nb_rejection_samples
    #             tp = tp < 1.0 ? tp : 1.0 - 0.65 * rand() / nb_rejection_samples
    ...
    # function update_tail_probabilities!(clusters::Vector{Cluster}, hyperparams::MNCRPHyperparams; nb_rejection_samples=10000)
    ...
    #     tail_prob = tail_probability(reduced_clusters, reduced_hyperparams, nb_rejection_samples=nb_rejection_samples)
