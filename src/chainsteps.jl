function advance_gibbs!(clusters::Vector{C}, hyperparams::AbstractFCHyperparams; temperature=1.0) where {C <: AbstractCluster}

    scheduled_elements = shuffle!(flatten(clusters))
...
function advance_gibbs!(element::AbstractVector{T}, clusters::AbstractVector{C}, hyperparams::AbstractFCHyperparams{T, D}; temperature::T=1.0) where {T, D, C}
...
#             advance_alpha!(clusters, hyperparams, step_size=exp(di.amwg_logscales.pyp.alpha))
#             advance_mu!(clusters, hyperparams, step_size=exp.(di.amwg_logscales.niw.mu))
#             advance_lambda!(clusters, hyperparams, step_size=exp(di.amwg_logscales.niw.lambda))
#             advance_psi!(clusters, hyperparams,step_size=exp.(di.amwg_logscales.niw.flatL))
#             advance_nu!(clusters, hyperparams, step_size=exp(di.amwg_logscales.niw.nu))
#             if hasnn(hyperparams)
#                 advance_nn_alpha!(hyperparams, step_size=exp(di.amwg_logscales.nn.t.alpha))
#                 advance_nn_scale!(hyperparams, step_size=exp(di.amwg_logscales.nn.t.scale))
#             end
#     end
